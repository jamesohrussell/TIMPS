...
fileidinU = "ERA5.USHR_800-400hPa."
fileidinV = "ERA5.VSHR_800-400hPa."

datadirout = "/uufs/chpc.utah.edu/common/home/u0816744/zips2/ERA5_derived/shear/"
fileidout1 = "ERA5.MSHR_800-400hPa.anomaly_"
...
def anomaly(d):
  ...
  mfns.write_var_compress("MSHR",
   "Wind shear magnitude average over 800-400 hPa","Full field",
  ...
  mfns.write_var_compress("MSHR_anom",
   "Wind shear magnitude anomaly average over 800-400 hPa",
   "Anomaly from 30 day running mean",
   ("time","latitude","longitude"),
   np.float64,"kg kg**-1",fileout1,varanom,lsd=3)

  mfns.write_var_compress("MSHR_anomn",
   "Normalized wind shear magnitude anomaly average over 800-400 hPa",
