...
datadirin = "/uufs/chpc.utah.edu/common/home/varble-group1/ERA5/winds/VWND/allplevs/"
datadirout = "/uufs/chpc.utah.edu/common/home/zipser-group2/ERA5_derived/shear/"
fileid  = "ERA5.VWND."
varname = "V"
varfile = "VSHR"
varfileln = "Meridional Wind Shear"
varfileds = "Meridional Wind Shear: 1000 - 850 hPa (~0-1.5 km tropics)"
...
#==================================================================
  ...
  mfns.write_var(varfile,varfileln,varfileds,
   ("time","latitude","longitude"),np.float64,dunits,fileout,var)
  fileout.close()
...
#for i in range(0,len(timestr1)): read_and_levdiff(i)

Parallel(n_jobs=6)(delayed(read_and_levdiff)(i) 
