...
fileidout1 = "ERA5.CONV_1000-850hPamean.anomaly_"
...
def anomaly(d):
  ...
  mfns.write_var_compress("CONV",
   "Convergence average over 1000-850 hPa","Full field",
  ...
  mfns.write_var_compress("CONV_anom",
   "Normalized convergence average over 1000-850 hPa",
