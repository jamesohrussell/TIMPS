...
labny = 8    # Number of y-labels between/incl. latS,latN
dx    = 0.1  # Grid-spacing in x (0.1 for IMERG)
dy    = 0.1  # Grid spacing in y (0.1 for IMERG)
latmn = 6   # Min lat for plotting
latmx = 12   # Max lat for plotting
lonmn = 164 # Min lon for plotting
lonmx = 170  # Max lon for plotting
