...
#==================================================================
  ...
  # Find files
  if nl.addrainchk: files["TCRW"] = E5fns.get_E5_ss_files(
    nl.dataE5dir,nl.fileTCRWE5id,timestrs[0],timestrs[-1])
  if nl.addTCWVE5: files["TCWV"] = E5fns.get_E5_ss_files(
    nl.dataE5dir,nl.fileTCWVE5id,timestrs[0],timestrs[-1])
  if nl.addCAPEE5: files["CAPE"] = E5fns.get_E5_ss_files(
  ...
  if nl.addSH18E5: files["SH18"] = E5fns.get_E5_ss_files(
    nl.dataE5dir,nl.fileSH18E5id,timestrs[0],timestrs[-1])
  if nl.addSH82E5: files["SH82"] = E5fns.get_E5_ss_files(
...
#==================================================================
    ...
    if nl.addctarea or \
      (nl.addctmean and nl.addrainchk):
    ...
    elif nl.addctmean and nl.addnorainchk:
...
#==================================================================
    ...
    if c==0:
      ...
      if nl.addTCWVE5:
        ...
        if nl.addctarea and nl.addnorainchk:
          TCWV_area_E5 = np.zeros((
           len(timestrs),len(yE5),len(xE5)))  

        if nl.addctmean and nl.addnorainchk: 
          TCWV_mean_E5 = [-999]*len(timestrs)
  
        if nl.addctarea and nl.addrainchk: 
          TCWV_area_nr_E5 = np.zeros((
           len(timestrs),len(yE5),len(xE5)))  

        if nl.addctmean and nl.addrainchk: 
...
#==================================================================
    ...
    if nl.addTCWVE5:
      ...
      # Get an area
      if nl.addctarea or nl.addctmean:
...
#==================================================================
  ...
  if nl.addctarea:
    ...
    if nl.addrainchk and nl.addctarea:
